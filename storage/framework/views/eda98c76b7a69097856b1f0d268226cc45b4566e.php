<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li><a href="/admin/order/show/<?php echo e($id); ?>"><?php echo e(trans('datatable.show')); ?></a></li>
    ...
    function deleteConfirmation(id) {
        swal({
            ...
            if (e.value === true) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(url('admin/order/delete')); ?>/" + id,
                    data: {_token: CSRF_TOKEN},
                    dataType: 'JSON',
                    success: function (results) {

                        if (results.success === true) {
                            $('#ordersdatatable5').DataTable().ajax.reload();
...
<?php /**PATH E:\emad\desktop\resources\views/admin/orders/btn/action.blade.php ENDPATH**/ ?>